---
title: Configure Thinkpad to keep running with closed lid
date: 2022-10-14
meta:
...
I have a 2nd hand Lenovo Thinkpad x250 with i7 5600u processor that I bought in November 2021. It worked great even in 2022, I used it as my daily driver with EndeavourOS. Really enjoyed the experience. Recently, the external battery was not being detected and that cut the battery life more than half, taking away the utility of having a portable laptop. It was collecting dust for a few weeks in my room, but I finally decided to use it as a linux server. 

## Laptops as servers

From what I gathered on the internet, old laptops can be great servers. I tried installing Debian, which already runs my other server, but it was a pain to install non-free firmware stuff for the laptop. So, I just went with Ubuntu 22.04 and it was set up in no time. 
...
This was the hard to get it right. All the methods I found online did not work or it was not up to my liking. After finding one [good enough config](https://askubuntu.com/a/1194293), the display turns off by itself after 1 minute and wakes up on any keypress. 
